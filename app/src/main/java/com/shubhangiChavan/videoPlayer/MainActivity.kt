...
import com.shubhangiChavan.videoPlayer.databinding.ActivityMainBinding
import com.shubhangiChavan.videoPlayer.databinding.ThemeViewBinding
            ...
            when (it.itemId) {
                R.id.themesNav -> {
                    ...
                    when (themeIndex) {
                        ...
                        2 -> bindingTV.themePurple.setBackgroundColor(Color.GRAY)
                        3 -> bindingTV.themeGreen.setBackgroundColor(Color.GRAY)
                        4 -> bindingTV.themeRed.setBackgroundColor(Color.GRAY)
